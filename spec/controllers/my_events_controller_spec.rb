...
RSpec.describe MyEventsController, type: :controller do
  let!(:user) do
    User.create!(provider: 1, uid: '123456789', email: 'leahwang61@berkeley.edu', first_name: 'Leah', last_name: 'Wang')
  end
  let!(:state) do
    State.create!(name: 'Texas', symbol: 'TX', fips_code: 48, is_territory: 0, lat_min: 25.84, lat_max: 36.5,
